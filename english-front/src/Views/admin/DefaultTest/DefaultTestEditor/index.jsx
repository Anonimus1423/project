...
import { DragAndDropQuizes } from "../../CreateClass/Components/DragAndDropQuizes";
import { TrashIcon } from "../../../../Icons/Admin";

const DefaultTestEditor = ({
  addQuize,
  dragAndDropquizes,
    ...
    <div className="flex gap-6">
      <div className="min-w-[330px] flex flex-col gap-5">
        <DragAndDropQuizes
          ...
          changeQuizes={(newQuizes) => dragAndDropquizes(newQuizes)}
        />
        <Button color="success" variant="outlined" onClick={addQuize}>
          Add New Quize
        </Button>
      </div>
      {selectedQuize ? (
...
export default DefaultTestEditor;
